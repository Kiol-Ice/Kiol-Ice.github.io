...
// Create a styled loading overlay
...
// Add a spinner to the loading overlay
...
// Add loading text to the overlay
const loadingText = document.createElement('div');
loadingText.style.marginTop = '20px';
loadingText.textContent = "Chargement du test...";
...
_flutter.loader.load({
  serviceWorkerSettings: {
    serviceWorkerVersion: '"2689768671"',
  },
  onEntrypointLoaded: async function (engineInitializer) {
    const appRunner = await engineInitializer.initializeEngine();

    loadingText.textContent = "Test prêt";
    await appRunner.runApp();

    // Remove the loading overlay once the app is running
